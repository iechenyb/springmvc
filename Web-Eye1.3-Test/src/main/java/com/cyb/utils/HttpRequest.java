...
public class HttpRequest {
    ...
    static String[] jhname=new String[]{"计划员1号","计划员2号","计划员3号","计划员4号","计划员5号","计划员6号",
    		"计划员7号","计划员8号","计划员9号","计划员10号","计划员11号","计划员12号","计划员13号",};
    ...
    public static void main(String[] args) {
    	sendGetJh("http://www.28ma.net/index.php?get=neirong&username=17NS1246227907&type=houerdanshi&time=",null);
    	System.out.println("计划员2号".substring(3, 4));
	}
}